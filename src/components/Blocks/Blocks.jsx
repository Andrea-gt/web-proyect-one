  ...
  return (
    <>
      <div className={styles.popular_titles}>
        ...
        <ul>
          <li>
            <a className={styles.popular_titles_link} href="https://www.sparknotes.com/shakespeare/macbeth/">
              <h2>Macbeth</h2>
              <span>William Shakespeare</span>
            </a>
          </li>
          <li>
            <a className={styles.popular_titles_link} href="https://www.sparknotes.com//shakespeare/hamlet/">
              <h2>Hamlet</h2>
              <span>William Shakespeare</span>
            </a>
          </li>
          <li>
            <a className={styles.popular_titles_link} href="https://www.sparknotes.com//shakespeare/romeojuliet/">
              <h2>Romeo and Juliet</h2>
              <span>William Shakespeare</span>
            </a>
          </li>
          <li>
            <a className={styles.popular_titles_link} href="https://www.sparknotes.com/lit/gatsby/">
              <h2>The Great Gatsby</h2>
              <span>F. Scott Fitzgerald</span>
            </a>
          </li>
          <li>
            <a className={styles.popular_titles_link} href="https://www.sparknotes.com/lit/mocking/">
      ...
      <div className={styles.blocks_container}>
        ...
        <div className={styles.guides_stories_container}>
          <div className={styles.study_guides}>
            ...
            <ul>
              ...
              <li>
                <a href="https://www.sparknotes.com/lit/a-court-of-thorns-and-roses/">
          ...
          <div className={styles.short_stories}>
            ...
            <ul>
              ...
              <li>
                <a href="https://www.sparknotes.com/short-stories/the-curious-case-of-benjamin-button/">
              ...
              <li>
                <a href="https://www.sparknotes.com/short-stories/the-ones-who-walk-away/">
        ...
        <div className={styles.william_information}>
          <div className={styles.information}>
            ...
            <p>
              Our comprehensive guide includes a detailed biography, social and historical context,
              quotes, and more to help you write your essay on Shakespeare or understand his plays and poems.
            </p>
            <button type="button">
              Read the guide
